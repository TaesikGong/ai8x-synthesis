...
if [ "$input_shape" = "3x32x32" ]; then
  log_path="2024.04.22-162616"
  config="networks/cifar10-hwc-ai85.yaml"
elif [ "$input_shape" = "12x32x32" ]; then
  log_path="2024.04.22-162621"
  config="networks/custom/data_folding/cifar10-hwc-ai85_12.yaml"
elif [ "$input_shape" = "48x32x32" ]; then
  log_path="2024.04.22-184835"
  config="networks/custom/data_folding/cifar10-hwc-ai85_48.yaml"
fi
...
dir='exp'
prefix="ai85-convnet5_${input_shape}"
