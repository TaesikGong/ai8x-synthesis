...
#
#for q in 8 4 2 1; do
#    cp="trained/custom/quantization_effect/ai87-cifar100-effnet2-qat${q}-q.pth.tar"
#    prefix="effnet2-qat${q}"
#
...
# original
cp="trained/custom/quantization_effect/2024.02.19-161005/best.pth.tar"
prefix="effnet2-qat-no"
